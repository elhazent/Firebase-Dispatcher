package com.elhazent.picodiploma.myfirebasedispatcher;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void startDispatcher(){
        ...
        Job myJob = mDispatcher.newJobBuilder().setService(MyJobService.class).setTag(DISPATCHER_TAG).setRecurring(true).setLifetime(Lifetime.UNTIL_NEXT_BOOT).setTrigger(Trigger.executionWindow(0,60)).setReplaceCurrent(true).setRetryStrategy(RetryStrategy.DEFAULT_EXPONENTIAL).setConstraints(Constraint.ON_UNMETERED_NETWORK, Constraint.DEVICE_CHARGING).setExtras(myExtrasBundle).build();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCancelScheduler = findViewById(R.id.btn_calcel_scheduler);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() ==  R.id.btn_calcel_scheduler){
            cancelDispatcher();
